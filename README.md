...
**本地 T9 准备：** 已补价值策略命令入口、冻结运行规格和独立单轮真实首返回/终态监督，仍只完成代码与契约验证；没有真实方法训练或 rollout。详见 [T9 准备记录](docs/t9_preparation_2026_09_13.md)。GitHub 已发布的审查快照为下面的 T6 修复＋T7＋T8，T9 本批暂未推送。
